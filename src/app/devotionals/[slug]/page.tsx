      ...
      <div className="page-shell section-gap animate-fade-in">
        ...
        {days.length === 0 ? (
          ...
          <div className="section-gap">
            ...
            {/* Locked days — blurred preview with cover + watermark unlock overlay */}
            {hasAccessControl && lockedDays.length > 0 && (
              <section className="space-y-6" aria-label="Locked devotional days">
                ...
                {lockedDays.map((day) => (
                  <LockedCoverOverlay
                    ...
                    subtitle={`${lockedDays.length - lockedDays.indexOf(day)} day${lockedDays.length - lockedDays.indexOf(day) === 1 ? "" : "s"} remaining • Purchase access or enter your access code`}
