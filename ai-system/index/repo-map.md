...
| `src/components/devotionals` | Public devotional components (reader protection, zoom/pagination, blank-overlay deterrence) | access-gate.tsx, anti-screenshot.tsx (blur overlay, getDisplayMedia hijack), purchase-checkout.tsx, content-reader.tsx (expand/zoom/page-input) |
